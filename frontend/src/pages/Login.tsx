							...
							<form onSubmit={handleSubmit} method="POST">
								<div className="space-y-5">
									<div className="flex flex-col items-start ">
										...
										<div className="w-full mt-2.5 relative text-gray-400 focus-within:text-gray-600">
									...
									<div className="text-center">
										<p className="text-base text-gray-600">
											...
											<Link
												to="/sign-up"
												className="font-medium ml-1 text-orange-500 transition-all duration-200 hover:text-orange-600 hover:underline"
											>
